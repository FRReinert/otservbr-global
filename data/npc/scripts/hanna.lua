...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "addon") or msgcontains(msg, "outfit") or msgcontains(msg, "hat") then
		...
		elseif addonProgress == 1 then
			npcHandler:say("Oh, you're back already? Did you bring 100 chicken feathers and 50 honeycombs?", cid)
	...
	if npcHandler.topic[cid] == 1 then
		if msgcontains(msg, 'yes') then
			...
			npcHandler:say('Okay, here we go, listen closely! I need a few things... 100 chicken feathers... and 50 honeycombs as glue. That\'s it, come back to me once you gathered it!', cid)
		else
